CLASS zcl_run_0145_0001 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_run_0145_0001 IMPLEMENTATION.
...
*last_changed_at       : abp_lastchange_tstmpl;
 ...
 data: lt_acc_categ type table of ztbacccateg0145,
          lt_catego    type table of ZTBCATEGO0145,
          lt_clientes  type table of ZTBCLIENTES0145,
          lt_clnts_lib type table of ZTBCLNTSLIB0145,
          lt_libros    type table of ZTBLIBROS0145.
...
******** TABLA1 ********
    ...
    delete from ztbacccateg0145.
    insert ztbacccateg0145 from table @lt_acc_categ.
...
******** TABLA2 ********
    ...
    "Delete possible entries; insert new entries
    delete from ZTBCATEGO0145.
    insert ZTBCATEGO0145 from table @lt_catego.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    delete from ZTBCLIENTES0145.
    insert ZTBCLIENTES0145 from table @lt_clientes.
...
******** TABLA4
    ...
    "Delete possible entries; insert new entries
    delete from ZTBCLNTSLIB0145.
    insert ZTBCLNTSLIB0145 from table @lt_clnts_lib.
    if sy-subrc eq 0.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ZTBLIBROS0145.
    insert ZTBLIBROS0145 from table @lt_libros.
   if sy-subrc eq 0.
